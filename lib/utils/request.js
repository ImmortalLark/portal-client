 ...
 * @Last Modified time: 2019-01-11 15:23:09
 */
...
module.exports = (req, {
  ...
  return new Promise((resolve, reject) => {
    ...
    req.method === "POST" && request.write(req.headers['content-type'].includes('json') ? JSON.stringify(req.body) : querystring.stringify(req.body));
    request.end();
